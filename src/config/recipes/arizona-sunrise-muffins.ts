...
export const arizonaSunriseMuffins: RecipeDefinition = {
  ...
  title: "Arizona Sunrise Muffins with Prickly Pear Jelly",
  seoTitle: "Arizona Sunrise Muffins with Prickly Pear Jelly | Easy Recipe",
  seoDescription:
  ...
  whyBody: [
    "Prickly pear jelly is a jelly made using prickly pear cactus fruit. It adds a distinctive fruit note and a vivid color to the muffin center without changing the basic muffin batter.",
    "Prickly pear is often described as fruity and distinctive, but flavor varies by fruit and preparation. In muffins, the jelly stays soft and glossy when sealed inside the batter.",
    "You can substitute another jam or jelly if needed, though prickly pear jelly gives these muffins their signature Southwest character.",
  ],
  techniqueSections: [
    {
    ...
    {
      headline: "How to Get a Clean Jelly Center",
      items: [
        "Use room-temperature jelly so it spreads easily into a small mound in the center.",
        "Press the jelly gently into the batter rather than pushing it to the side.",
        "Fill the top layer of batter evenly so no jelly peeks through before baking.",
        "Let muffins cool in the pan briefly, then transfer to a rack — cutting while hot can make the center run.",
      ],
    },
  ],
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        "Prickly pear jelly is a jelly made using prickly pear cactus fruit. Prickly pear is often described as fruity and distinctive, but flavor varies by fruit and preparation.",
    },
    {
      question: "Can I use another jam instead of prickly pear jelly?",
      answer:
        "Yes. Any thick, spoonable jam or jelly can work. Prickly pear jelly gives these muffins their Southwest character, but raspberry, apricot, or other fruit jams are reasonable substitutes.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Bake for 20–25 minutes. Exact time depends on your oven and muffin size — start checking at 20 minutes.",
    },
    {
      question: "What is prickly pear jelly?",
      answer:
        "Prickly pear jelly is a jelly made using prickly pear cactus fruit, typically with sugar and pectin. Cheri's Desert Harvest Prickly Pear Cactus Jelly uses organic prickly pear cactus, organic lemon juice, pure cane sugar, citrus pectin, and citric acid.",
    },
    {
  ...
  moreUses: [
    ...
    },
    {
      ...
      href: "/prickly-pear-guide#uses",
      description: "Pair with soft cheeses and crackers for a Southwest-inspired spread.",
    },
  ],
  images: {
  ...
  sourceMessages: {
    ...
    "facebook-easy-homemade-muffins":
      "Easy homemade muffins with a bright jelly surprise inside — full directions below.",
  },
};
